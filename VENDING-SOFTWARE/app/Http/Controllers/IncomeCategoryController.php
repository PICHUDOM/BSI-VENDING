...
class IncomeCategoryController extends Controller
{
    ...
    public function update(Request $request, IncomeCategory $product, $id)
    {
        ...
        $incoeCat->p_name = $validatedData['type'];
        $incoeCat->expiry_date = $validatedData['price'];
        $incoeCat->update();

        return redirect('/incomecategory')->with('flash_message', 'Product Updated Successfully');
    }
