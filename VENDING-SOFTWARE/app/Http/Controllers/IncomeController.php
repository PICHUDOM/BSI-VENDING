...
class IncomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Income::all();
        return view('contents/income', compact('data', 'categories','machine'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Income data has been saved successfully.');
    }
    ...
    public function destroy(Income $income,$id)
    {
        //
        Income::destroy($id);
        return redirect('income')->with('flash_message', 'Data deleted!');
    }
}
