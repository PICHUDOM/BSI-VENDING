        ...
        <div class="card-body myForm">
            ...
            <div class="row g-3">
                <div class="content">
                    <div class="container">
                        <div class="col-md-12">
                            <form action="{{ url('update_machine/'.$data->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                    ...
                                    <div class="card-body">
                                        <div class="row col-md-12">
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input type="text" name="m_name" class="form-control" value="{{$data->m_name}}">
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="slot" class="form-label">Slot</label>
                                                <input type="text" name="slot" class="form-control" value="{{$data->slot}}">
                                            </div>
                                        </div>
                                        <div class="row col-md-12">
                                            <div class="mb-3 col-md-6">
                                                <label for="installation_date" class="form-label">Installation
                                                    date</label>
                                                <input type="date" name="installation_date" class="form-control" value="{{$data->installation_date}}">
                                            </div>
                                            <div class="mb-3 col-md-6">
