    ...
    <div class="content">
        <div class="container">
            <div class="page-title">
                <h3 id="myTab" role="tablist">Income Category
                    <a class="btn btn-sm btn-outline-primary float-end" id="slot-tab" data-bs-toggle="tab" href="#slot"
                        ...
                        <i class="fas fa-plus-circle"></i><span class="btn-header">Add Category</span>
                                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="income_category/destroy/{{ $data->id }}" class="btn btn-outline-danger btn-rounded"
            ...
            <div class="tab-pane fade" id="slot" role="tabpanel" aria-labelledby="slot-tab">
                <div class="content">
                    <div class="container">
                        <div class="col-md-12">
                            <form action="{{ url('/create-income_category') }}" method="post" enctype="multipart/form-data">
                                @csrf
